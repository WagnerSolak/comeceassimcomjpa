...
public class Configuracao {
    ...
    @MapsId  // a coluna referente a este relacionamento será uma primaryKey, não permitindo nulo
    @OneToOne
    @JoinColumn(name = "usuario_id", foreignKey = @ForeignKey(name = "fk_configuracao_usuario"))
